package com.vsv.chirp.api.config

import com.vsv.chirp.domain.exception.RateLimitException
import com.vsv.chirp.infra.rate_limiting.IpRateLimiter
import com.vsv.chirp.infra.rate_limiting.IpResolver
            ...
            if (annotation != null) {
                ...
                return try {
                    ipRateLimiter.withIpRateLimit(
                        ...
                        maxRequestsFromIp = annotation.requests,
                        action = { true }
                    )
