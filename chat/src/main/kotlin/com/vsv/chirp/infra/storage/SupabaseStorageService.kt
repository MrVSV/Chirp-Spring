...
class SupabaseStorageService(
    ...
    fun generateSignedUploadUrl(userId: UserId, mimeType: String): ProfileImageUploadCredentials {
        val extension = allowedMimeTypes[mimeType]
            ?: throw InvalidProfileImageException("Invalid mime type $mimeType")
        ...
        return ProfileImageUploadCredentials(
